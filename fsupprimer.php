				...
				<br/>
					<div class="w3-card-4">
						<div class="w3-container w3-green">
							<h4>Supprimer producteur </h4>
						</div>
						<form id="fsupProducteur" name="fsupProducteur" method="post" class="w3-container" action="controller/traitement.php">
							<p>
							...
							<p>
							<button type="button" class="w3-btn form-submit w3-green" id="soumettre" onclick="suppProducteur();" name="soumettre"> <em> Soumettre </em> </button> 
							<button type="reset" class="w3-btn form-submit w3-indigo" name="annuler"> <em> Annuler </em> </button> </td></tr>
				  			
							<input type="hidden" name="action" id="action" value="supProducteur"/>
